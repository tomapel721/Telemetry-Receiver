...
namespace NRF24
{
	...
	const uint8_t TX_ADDR = 0x10;     // <- not used yet
	...
	const uint8_t CMD_R_RX_PAYLOAD = 0x61; // not used yet
	const uint8_t CMD_DATA_WRITE = 0x20; 
	const uint8_t CMD_DATA_READ = 0x00;

									/****** Specific bits in NRF24 registers ******/

						/* note: the name convention is like: BIT_<name of register>__<name of bit> */
