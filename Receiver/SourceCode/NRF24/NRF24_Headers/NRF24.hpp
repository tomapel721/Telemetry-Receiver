...
namespace NRF24
{
	...
	public:
		...
		*/
        ...
        /* The function initialize all GPIO pins as inputs
         */
        void initGPIO();
    ...
    public:
		...
		*/
		...
		void DisableDynamicPayload(); // will be hardcoded for disabled dynamic payload - not worked

        /* The function sets the payload size to 32
         * @param numberOfPipe pipe number - on this pipe payload will be set to 32
         */
		void SetPayloadSize(uint8_t numberOfPipe); // will be hardcoded because we don't use dynamic payload
